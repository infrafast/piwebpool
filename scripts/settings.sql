...
INSERT INTO `settings` (`id`,`value`,`userSetting`,`description`) VALUES ('actionTable','1',-1.5,'Temperature calibration offset'),('actionTable','0',0,''),('blocklyTable','1',0,''),('domoURL','http://admin:Quintal74604@domoticz.infrafast.com/json.htm?type=command',1,'API pour domoticz ou autre'),('e_mail','szemrot@hotmail.com',1,'email recevant les notifications'),('logTable','1',0,''),('measureIndex','27',0,'Compteur dernière mesure'),('ORPConsign','750',1,'Consigne ORP'),('Parametres','0',0,''),('PHConsign','7.24',1,'Consigne PH'),('Planificateur','0',0,''),('prowlURL','https://api.prowlapp.com/publicapi/add?apikey=0e139710aceccf6abc6865983a98f0439a0e5ba2&application=piwebpool&event=%m&description=%v',1,''),('scheduler','1',1,'Activation planificateur filtration'),('sensorTable','0',0,''),('Souscripteurs','1',0,''),('TEMPConsign','28',1,'Consigne de tempÃ©rature');
