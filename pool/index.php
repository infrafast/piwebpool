...
<tr height="80px">
    ...
    <script>
        ...
        for (var tableID in collapsableTableList) {
          if (actionCall('action=getSetting&id='+collapsableTableList[tableID],false)=="1",false,"table:"+tableID,true) document.getElementById(collapsableTableList[tableID]).click();
        }
