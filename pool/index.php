...
<tr height="80px">
    ...
    <script>
        ...
        for (var tableID in collapsableTableList) {
          if (actionCall('action=getSetting&id='+collapsableTableList[tableID],false,"table:"+collapsableTableList[tableID],true)=="1") document.getElementById(collapsableTableList[tableID]).click();
        }
