    ...
    <script>
      ...
      var workspace = Blockly.inject('blocklyDiv',
        ...
        function updateGraph(element){
            ...
            var imgSrc = 'url('+link+element.id+'&period='+document.getElementById('periodID').value+'&width='+element.offsetWidth+'&height='+element.element.parentNode.offsetHeight+'&type='+element.classList.item(0)+')';
