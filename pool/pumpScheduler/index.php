...
<tr><th>Valeur</th></tr>
<tr><td><textarea id="logFile" readonly style="color: grey; background-color: lightgrey width: 100%; height: 150px;"></textarea></td></tr>
</table>
...
<script>
    // retrieve logfile
    document.getElementById('logFile').value = "MY LOG";
