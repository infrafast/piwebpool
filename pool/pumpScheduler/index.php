...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <tr height="180px" id="graphID">
        <td id="graph=ph" onclick="toggleGraph(this);" style="background-repeat:no-repeat; background-image: url('images/loading.gif');"></td>
        <td id="graph=orp" onclick="toggleGraph(this);" style="background-repeat:no-repeat; background-image: url('images/loading.gif');"></td>
        <td id="graph=temperature" onclick="toggleGraph(this);" style="background-repeat:no-repeat; background-image: url('images/loading.gif');"></td>
    </tr>
    <tr>
    ...
    <tr height=80px>
    	<?php echo "<td id='".$material."CellID' onclick='toggleGraph(this)' style=\"background-image:url(graph.php?graph=".$materialsColumn[$material]."&period=24&width=850&height=90&title=".$material."&type=textType); background-repeat:no-repeat;background-size: 100% 100%;\">"?></td>
    ...
    <script>
      ...
      var workspace = Blockly.inject('blocklyDiv',
        ...
        function updateGraph(element,typeGraph){
            ...
            var imgSrc = 'url(graphi.php?'+element.id+'&period='+document.getElementById('periodID').value+'&width=500&height=200&type='+typeGraph+')'; 
