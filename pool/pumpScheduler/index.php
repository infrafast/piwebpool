...
<tr>
    <td>PH</td>
    <td><div onclick="refreshPh()" class=""></div><?php echo getPh(); ?>°C</td>
</tr>
<tr>
    <td>Redox</td>
    <td><div onclick="refreshORP()" class=""></div><?php echo getORP(); ?>mv</td>
</tr>
<tr>
    <td>Temperature</td>
    <td><div onclick="refreshTemp()" class=""></div><?php echo getTemperature(); ?>°C</td>
</tr>
</table>
