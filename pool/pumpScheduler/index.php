...
<tr height=80px>
	...
	<td><div onclick="changeState(<?php echo $pin; ?>,this)" class="buttonState <?php echo (getPinState($pin,$pins)==1?'on':'off'); ?>"><br><?php echo getPinState($pin,$pins)==1?'on':'off'; ?><br><br></div></td>
</tr>
<?php } ?>
</table>
