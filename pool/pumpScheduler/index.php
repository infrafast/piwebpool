...
<tr>
    <td>PH</td>
    <td><div onclick="refreshPh()" class=""><?php echo getPh(); ?></div>°C</td>
</tr>
<tr>
    <td>Redox</td>
    <td><div onclick="refreshORP()" class=""><?php echo getORP(); ?></div>mv</td>
</tr>
<tr>
    <td>Temperature</td>
    <td><div onclick="refreshTemp()" class=""<?php echo getTemperature(); ?>></div>°C</td>
</tr>
</table>
