...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <tr "height=80px" id="commandsTableID">
    	<?php echo "<td class='textType' id='graph=".$materialsColumn[$material]."' onload='updateGraph(this);' onclick='toggleGraph(this);' style=\"background-image:url(images/loading.gif); background-repeat:no-repeat;\">"?></td>
