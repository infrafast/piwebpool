...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <tr>
        <td id="PhCalibrateID" style="background-repeat:no-repeat; background-image: url('images/loading.gif');"><input type="button" value="Etalonner (ph7)" onclick="calibrateAndRefresh('Ph');"></td>
