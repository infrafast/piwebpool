...
<tr>
    <td>PH</td>
    <td><div onclick="refreshPh(this);" class="buttonState off"><?php echo getPh(); ?></div></td>
</tr>
<tr>
    <td>Redox (mV)</td>
    <td><div onclick="refreshORP(this);" class="buttonState off"><?php echo getORP(); ?></div></td>
</tr>
<tr>
    <td>Temperature (°C)</td>
    <td><div onclick="refreshTemp(this);" class="buttonState off"><?php echo getTemperature(); ?></div></td>
</tr>
</table>
