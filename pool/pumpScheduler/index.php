...
<tr>
	<td style="background-image:url('graph.php?graph=pump&period=24&width=500&height=100&type=bar');background-repeat:no-repeat;background-size: 100% 100%;"><?php echo $material; ?></td>
