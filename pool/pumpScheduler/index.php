...
<tr>
    ...
    <xml id="toolbox" style="display: none">
     ...
     <td>Script
        ...
        <br>
        <textarea rows="18" cols="35" id="scriptarea" readonly style="color: grey; background-color: lightgrey"></textarea></div>
     </td>
</tr>
</table>
...
<tr><th>Valeur</th></tr>
<tr><td width="100%"><textarea id="logFile" readonly style="color: grey; width: 100%; height: 150px;"></textarea></td></tr>
</table>
