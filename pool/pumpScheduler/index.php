...
<tr>
    <td><div onclick="refreshValue(this,'Ph');" class="buttonState off"><?php echo "<br>".getPh()."<br>"; ?><br></div></td>
    <td><div onclick="refreshValue(this,'ORP');" class="buttonState off"><?php echo "<br>".getORP()."<br>"; ?></div></td>
    <td><div onclick="refreshValue(this,'Temperature');" class="buttonState off"><?php echo"<br>".getTemperature()."<br>"; ?></div></td>
</tr>
<tr>
    <td></td>
