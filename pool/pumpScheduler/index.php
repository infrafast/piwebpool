...
<tr>
    <td style='background-image:url(graph.php?graph=ph);background-repeat:no-repeat;background-size: 100%;'></td>
    <td style='background-image:url(graph.php?graph=orp);background-repeat:no-repeat;background-size: 100%;'></td>
    <td style='background-image:url(graph.php?graph=temperature);background-repeat:no-repeat;background-size: 100%;'></td>
</tr>
</table>
