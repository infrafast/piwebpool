...
<tr><th>Valeur</th></tr>
<tr><td><textarea id="scriptarea" readonly style="color: grey; background-color: lightgrey width: 100%; height: 150px;">LOG GOES HERE</textarea></td></tr>
</table>
...
<script>
    // retrieve logfile
    document.getElementById('scriptarea').value = getLog();
