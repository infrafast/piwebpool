...
<tr>
	<?php echo "<td style=\"background-image:url('graph.php?graph=pump&period=24&width=400&height=100&type=bar&title=".$material."');background-repeat:no-repeat;background-size: 100% 100%;\">"?>
	</td>
