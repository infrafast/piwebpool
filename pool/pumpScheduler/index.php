...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <tr height=80px>
    	<?php echo "<td class='textType' id='graph=".$materialsColumn[$material]."' onclick='toggleGraph(this);' style=\"background-image:url(graph.php?graph=".$materialsColumn[$material]."&period=8&width=850&height=90&title=".$material."&type=textType); background-repeat:no-repeat;background-size: 100% 100%;\">"?></td>
    ...
    <script>
      ...
      var workspace = Blockly.inject('blocklyDiv',
        ...
        function updateGraph(element,typeGraph){
            ...
            var imgSrc = 'url(graph.php?'+element.id+'&period='+document.getElementById('periodID').value+'&type='+typeGraph+'&width='+element.width()+'&height='+element.height()+')';
        ...
        function toggleGraph(element){
            ...
            alert('currentGraphType '+currentGraphType)
