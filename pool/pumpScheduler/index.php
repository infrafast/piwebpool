...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <tr height=80px>
    	<?php echo "<td id='".$material."cellID' style=\"background-image:url('graph.php?graph=".$materialsColumn[$material]."&period=24&width=850&height=90&type=text&title=".$material."'); background-repeat:no-repeat;background-size: 100% 100%;\">"?></td>
