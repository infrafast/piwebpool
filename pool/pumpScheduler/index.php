...
<tr>
    <td><input type="button" value="Etalonner (ph7)" onclick="actionCall('{action: \'calibrate\'',false,'Placer la sonde dans Ph7 pendant 2 minutes puis confirmez',true, true);"></td>
