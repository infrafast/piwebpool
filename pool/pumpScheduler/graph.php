...
$sql    = "selectZ ".$_GET["graph"].",id, timeStamp from (select ".$_GET["graph"].", id, timeStamp from measures order by id desc) tempTable order by timeStamp ASC limit ".intval($_GET["period"]);
