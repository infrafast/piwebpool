...
$sql    = "select ".$_GET["graph"].",id, timeStamp from (select ".$_GET["graph"].", id, timeStamp from measures order by id asc) tempTable order by timeStamp desc limit ".intval($_GET["period"]);
