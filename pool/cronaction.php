...
if (!$result) {
    ...
    if (!$result) {
        ...
        if (!$result) {
            ...
            if (!weburl($materials,$pins,"http://admin:Quintal74602@domoticz.infrafast.com/json.htm?type=command&param=udevice&idx=27&nvalue=0&svalue=%ph")) $state.="{api update ph failed}";
