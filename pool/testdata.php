...
//increase
generate(24,7.2,7.2,300,300,$link,$materialsColumn,$materials,$pins);
//decrease
    ...
    for ($x = 0; $x <= $period; $x++) {
        ...
        if (!$result) {
            ...
            if (!$result) {
                ...
                $phValue+=$phStep+(rand(0,5)<2?0:intval(rand(-$phValue*0.02,$phValue*0.05)));
                $orpValue+=$orpStep+(rand(0,5)<2?0:intval(rand(-$orpValue*0.02,$orpValue*0.05)));
