...
if AVERAGE_value > LIMITE_HAUTE+1 and AVERAGE_value < LIMITE_HAUTE+3:
    ALERT = 1
    message = message + " [HIGH LEVEL]"

#niveau bas: risque de desarmorce de la pompe
if AVERAGE_value < LIMITE_BASSE-1 and  AVERAGE_value > LIMITE_BASSE-3 :
    ALERT = 1
