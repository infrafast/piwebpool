...
rrdtool graph $DIR/v_cuve_60.png --start -60s --title="Hauteur d'eau filtrée sur 60s" --vertical-label="cm" DEF:capa=$DIR/capa_cuve.rrd:capa:AVERAGE LINE1:capa$COUL_VOLUME:"Hauteur d'eau en $ECHELLE\n" GPRINT:capa:LAST:"Mesure\: %.0lf" GPRINT:capa:AVERAGE:"Moy\: %.0lf" GPRINT:capa:MIN:"Mini\: %.0lf" GPRINT:capa:MAX:"Maxi\: %.0lf" COMMENT:" \n" COMMENT:"Dernier releve $JOUR"
