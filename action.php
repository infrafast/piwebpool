            ...
            switch($_['id']){
                ...
                case 'Temp':
                    ...
                    if (isset($_['value'])){
                        ...
                        $query="INSERT INTO `settings` (`id`, `value`, `userSetting`, `description`) VALUES ('".$url."', '".$material."', '".$valueOn."', '".$valueOff."') ON DUPLICATE KEY UPDATE url='".$url."',material='".$material."',valueOn='".$valueOn."',valueOff='".$valueOff."'";
