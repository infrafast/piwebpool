            ...
            switch($_['id']){
                ...
                case 'Temp':
                    ...
                    if (isset($_['value'])){
                        ...
                        $query="INSERT INTO `settings` (`url`, `material`, `valueOn`, `valueOff`) VALUES ('".$url."', '".$material."', '".$valueOn."', '".$valueOff."') ON DUPLICATE KEY UPDATE url='".$url."',material='".$material."',valueOn='".$valueOn."',valueOff='".$valueOff."'";
