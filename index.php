...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <tr height="80px">
    	...
    	<td><div id=<?php echo "'commandButtonID".$material."'";?> onclick="changeState(<?php echo "'".$material."'"; ?>,this)" class="arrondi buttonState"><?php echo "<br>".(getPin($pins[$materials[$material]])==1?'on':'off')."<br><br>";?></div></td>
    </tr>
    <?php } ?>
    </table>
