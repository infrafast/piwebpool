...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <tr>
        ...
        <td id="TempCalibrateID" style="background-repeat:no-repeat; background-image: url('');"><input type="button" value="Etalonner" disabled onclick="calibrateAndRefresh('Temp',document.getElementById('orpCalValueID').value);"><input type="text" id="orpCalValueID" name="orpCalValue" value="650" maxlength="4" size="4">mV</td>        
        <td></td>
    </tr>
    </table>
